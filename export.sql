--------------------------------------------------------
--  File created - œroda-maja-22-2019   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SZKOLAJAZDY"."HIBERNATE_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SZKOLAJAZDY"."REZERWACJE" 
   (	"REZERWACJA_ID" NUMBER(*,0), 
	...
	"DATA_DODANIA" DATE, 
	"INSTRUKTORID" NUMBER(19,0), 
	"KURSANTID" NUMBER(19,0), 
	"USLUGAID" NUMBER(19,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
SET DEFINE OFF;
Insert into SZKOLAJAZDY.HIBERNATE_SEQUENCES (SEQUENCE_NAME,NEXT_VAL) values ('default','8');
REM INSERTING into SZKOLAJAZDY.INSTRUKTORZY
SET DEFINE OFF;
Insert into SZKOLAJAZDY.INSTRUKTORZY (INSTRUKTOR_ID,IMIE,NAZWISKO,GODZ_ROZPOCZECIA,GODZ_ZAKONCZENIA,DATA_DODANIA,EMAIL,HASLO,CZY_ADMIN) values ('0','Mateusz','Sliwka','10:00','18:00',to_date('19/05/22','RR/MM/DD'),'mateosl@wp.pl','test123','1');
Insert into SZKOLAJAZDY.INSTRUKTORZY (INSTRUKTOR_ID,IMIE,NAZWISKO,GODZ_ROZPOCZECIA,GODZ_ZAKONCZENIA,DATA_DODANIA,EMAIL,HASLO,CZY_ADMIN) values ('1','Test','Instruktor','08:00','22:00',to_date('19/05/20','RR/MM/DD'),'test@instruktor.pl','haslo','0');
...
SET DEFINE OFF;
Insert into SZKOLAJAZDY.KURSANCI (KURSANT_ID,IMIE,NAZWISKO,PESEL,EMAIL,PKK,HASLO,DATA_REJESTRACJI) values ('6','d','e','f','a','g','b',to_date('19/05/22','RR/MM/DD'));
...
Insert into SZKOLAJAZDY.KURSANCI (KURSANT_ID,IMIE,NAZWISKO,PESEL,EMAIL,PKK,HASLO,DATA_REJESTRACJI) values ('7','d','e','f','b','g','c',to_date('19/05/22','RR/MM/DD'));
Insert into SZKOLAJAZDY.KURSANCI (KURSANT_ID,IMIE,NAZWISKO,PESEL,EMAIL,PKK,HASLO,DATA_REJESTRACJI) values ('8','d','e','f','a','g','s',to_date('19/05/22','RR/MM/DD'));
...
--------------------------------------------------------
  ...
  ALTER TABLE "SZKOLAJAZDY"."PLATNOSCI" MODIFY ("REZERWACJA_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SZKOLAJAZDY"."PLATNOSCI" ADD CONSTRAINT "PLATNOSCI_FK1" FOREIGN KEY ("REZERWACJA_ID")
	  REFERENCES "SZKOLAJAZDY"."REZERWACJE" ("REZERWACJA_ID") ENABLE;
--------------------------------------------------------
